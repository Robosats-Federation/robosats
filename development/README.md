...
Check out our [Contribution Guide](https://learn.robosats.app/contribute/) to find how you can make RoboSats great.
...
RoboSats is a monorepo, arguably a messy one at the moment.
 ...
 - The `/nodeapp` directory contains the docker orchestration and utilities for the self-hosted application (Umbrel, StartOS, etc). We also use this one in unsafe.robosats.app

 - The `/mobile` directory contains our React Native app (a wrapper around our ReactJS app in `/frontend`)
 - The `/docs` directory has the learn.robosats.app static Jekyll site markdown docs.
...
Officially mantained docker orchestration for coordinators can be found in the repo [robosats-deploy](https://github.com/Robosats-Federation/robosats-deploy)
