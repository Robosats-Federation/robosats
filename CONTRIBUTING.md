...
Anyone is welcome to contribute to Robosats. If you're looking for somewhere to start contributing, check out the [good first issue](https://github.com/Robosats-Federation/robosats/issues?q=is%3Aopen+is%3Aissue+label%3A"good+first+issue") list.
