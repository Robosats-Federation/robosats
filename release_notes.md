RoboSats v0.8.5-alpha is now out! :rocket:
...
[Coordinator Backend Image v0.8.5-alpha (Docker Hub)](https://hub.docker.com/r/recksato/robosats/tags?page=1&name=v0.8.5-alpha)
...
[Client App Image v0.8.5-alpha (Docker Hub)](https://hub.docker.com/r/recksato/robosats-client/tags?page=1&name=v0.8.5-alpha)
