...
### For both bitcoin buyer and seller
  ...
  1. Make sure to checking out the  <a href="https://github.com/Robosats-Federation/robosats/blob/active-maintenance/docs/how-to-use.md">How to use </a>section before begin trading.<br>
