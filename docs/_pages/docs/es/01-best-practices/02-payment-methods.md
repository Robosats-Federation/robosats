...
### Para ambos comprador y vendedor de bitcoin
  ...
  1. Asegúrate de revisar la seccion <a href="https://github.com/Robosats-Federation/robosats/blob/active-maintenance/docs/_pages/tutorials/read/how-to-use_es.md">Cómo usar </a>antes de empezar a intercambiar.<br>
