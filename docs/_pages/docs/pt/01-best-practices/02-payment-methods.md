...
1. Não deixe de conferir a seção <a href="https://github.com/Robosats-Federation/robosats/blob/active-maintenance/docs/_pages/tutorials/read/how-to-use_es.md">Como usar </a >antes de começar a negociar.<br>
