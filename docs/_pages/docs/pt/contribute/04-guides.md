...
Para fornecer aos seus leitores/telespectadores as informações mais precisas sobre a plataforma, considere dar uma olhada breve na documentação do RoboSats aqui em [learn.robosats.app](https://learn.robosats.app/pt/). Lá você encontrará muitas características e aspectos do RoboSats em detalhes refinados, bem como alguns [tutoriais previamente criados](https://learn.robosats.app/watch/pt/) que podem ajudar como referência para o seu tutorial.

Se você tiver perguntas persistentes que não forem respondidas na documentação, não hesite em perguntar no [grupo de suporte público do SimpleX](https://learn.robosats.app/contribute/code/#communication-channels)..
