...
**Note** this is a very early release, so expect to find bugs! If you find a bug that is stopping you from continuing your order, recover your robot in the v0.5.3 client of your coordinator and continue the trade as usual. We keep a [list of known bugs here](https://github.com/Robosats-Federation/robosats/issues/1069), please report if you find a new one :D
{: .notice--primary}
...
The new federated client will now be permanently available in http://robosats7kriiz4seodfs3nvwprqbpntibrtmouj7xkznmhokv7qkqqd.onion
(visit with Tor Browser) and http://unsafe.robosats.app (with extremely limited functionality). Once stable, it will be released as version v0.6.0 and you will be able to install it as usual on your node (e.g., [Umbrel](https://apps.umbrel.com/app/robosats), [StartOS](https://github.com/Robosats-Federation/robosats-startos/releases), etc).
...
If you operate a lightning node and are interested in becoming a coordinator yourself, refer to the [RoboSats Federation basis](https://github.com/Robosats-Federation/robosats/blob/active-maintenance/federation.md)
